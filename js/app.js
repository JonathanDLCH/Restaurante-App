...
const platillo5 =  new Platillo(5,'Moules Frites',237,'Mejillones cocinados al vapor con papas fritas que los franceses del norte del país.','Entrada','img/Moules-frites.jpg');
const platillo6 =  new Platillo(6,'Foie gras',80,'Los franceses comen el hígado de ganso con pan y mermelada.','Entrada','img/Foie-gras.jpg');
const platillo7 =  new Platillo(7,'Escargot',400,'Caracol de Borgoña o caracol de viña y el caracol común de jardín. Se comen principalmente con mantequilla de ajo.','Entrada','img/Escargot.jpg');
const platillo8 =  new Platillo(8,'Ancas de Rana',973,'Crujientes ancas de rana se comen con sal, mantequilla y perejil.','Entrada','img/Ancas-de-rana.jpg');
const platillo9 =  new Platillo(9,'Buey ala Borgoñona',600,'Es un estofado de buey de muy lenta cocción en vino tinto borgoñés, añadiendo ajo, cebolla, zanahoria y un bouquet garni, el típico manojo de hierbas aromáticas.','Entrada','img/Buey-a-la-Borgona.jpg');
const platillo10 =  new Platillo(10,'Crepas',70,'Estos delgados discos de harina de trigo, huevos y leche. Crepas saladas:carnes,setas y quesos. Crepas dulces:frutas, helados y mermeladas.','Entrada','img/Crepas.jpg');
...
const pintarFooter = () => {
    ...
    const nCantidad = Object.values(ordenes).reduce((acc, { cantidad }) => acc + cantidad, 0)
    const nPrecio = Object.values(ordenes).reduce((acc, {cantidad, precio}) => acc + cantidad * precio ,0)
    // console.log(nPrecio)
